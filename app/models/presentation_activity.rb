class PresentationActivity < ApplicationRecord
  belongs_to :lesson, optional: true
  mount_uploader :slide_file, FileUploader
  ...
  def file_size_validation
    errors[:slide_file] << "should be less than 10MB" if slide_file.size > 10.megabytes
  end
end
